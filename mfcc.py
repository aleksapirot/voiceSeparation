...
def fbank(signal, samplerate=16000, winlen=0.025, winstep=0.01,
    ...
    global cache, cache_params
    if 'cache_params' in globals() and nfilt == cache_params[0] and nfft == cache_params[1] and samplerate == cache_params[2] and lowfreq == cache_params[3] and highfreq == cache_params[4]:
        fb = cache
    else:
        fb = get_filterbanks(nfilt, nfft, samplerate, lowfreq, highfreq).T

        cache = fb
        cache_params = [nfilt, nfft, samplerate, lowfreq, highfreq]
